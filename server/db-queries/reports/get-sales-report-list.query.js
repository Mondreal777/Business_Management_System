 ...
 * @param {Object} params
 */
 async function getSalesReportList(params) {
    try {
        ...
        WHERE t.status = 'DONE' AND ti.status = 'DONE' 
...
async function getSalesReportListCount(params) {
    try {
...
module.exports = { getSalesReportList, getSalesReportListCount }