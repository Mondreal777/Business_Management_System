            ...
            b-modal.deleteModal(v-model='isSuccessModalActive' 
                            ...
                            .modal-card(style='width: auto')
                              ...
                              section.modal-card-body
                                ...
                                b-field(label='Successfully updated Surcharge!')
...
export default {
    name: "surchargesEditSectionComponent",
    components: {
        Header,
        Sidebar
    },
    ...
    methods: {
        ...
        async getItemData(){
          ...
          const itemInput = await axios.get(`${process.env.VUE_APP_API_BASE_URL}/surcharges/edit/` + this.$store.getters.getDiscountAndSurchargesId);
          const item = itemInput.data.results.data.surchargesData;
          
          this.name = item.surcharges_name;
          ...
          if (!this.name || !this.amount || !this.type) {
            ...
            try {
              ...
              axios.post(`${process.env.VUE_APP_API_BASE_URL}/surcharges/save-details`, {
                surchargesId: this.$store.getters.getDiscountAndSurchargesId,
              ...
              this.saveAuditTrail(loginDetails["loginUserId"], 'Surcharges', 'Update surcharges', null, null);
            } catch(e) {
              console.error(e);
            }
          }
